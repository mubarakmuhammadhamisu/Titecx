...
export default function ReferralDashboard() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      {/* Header — stacks on mobile, row on sm+ so the Leaderboard button doesn't squish the title */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-900 border border-indigo-500/20 text-sm text-indigo-300 hover:border-indigo-500/50 transition self-start sm:self-auto"
        >
