    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-linear-to-r from-indigo-500 to-indigo-600 px-4 py-2 font-medium text-white hover:from-indigo-600 hover:to-indigo-700 transition-all duration-300 shadow-lg shadow-indigo-500/30"
        >
          <Plus size={18} />
          Create Coupon
        </button>
        ...
        footer={
          <>
            ...
            <button
              ...
              className="flex-1 rounded-lg bg-linear-to-r from-indigo-500 to-indigo-600 px-4 py-2 font-medium text-white hover:from-indigo-600 hover:to-indigo-700 transition"
            >
