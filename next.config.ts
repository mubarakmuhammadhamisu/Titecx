...
const securityHeaders = [
  ...
  // 'unsafe-inline' is required for script-src (Next.js hydration) and style-src (Tailwind).
  {
    ...
    value: [
      ...
      "frame-src https://www.youtube.com https://www.youtube-nocookie.com https://www.checkout.paystack.com https://*.paystack.com",
      "img-src 'self' data: blob: https://*.supabase.co https://*.supabase.in https://img.youtube.com https://*.paystack.com",
      "connect-src 'self' https://*.supabase.co https://*.supabase.in https://api.paystack.co https://checkout.paystack.com https://*.paystack.com",
